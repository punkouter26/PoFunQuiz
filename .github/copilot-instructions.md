...
Every solution must maintain three distinct test projects using Docker Testcontainers for infrastructure parity:
...
Minimalist API: If the WASM client requires data, create minimal endpoints within the Server project. A separate API project is not required.
